...
if [ -d "$HOME/.local/share/zsh/zsh-snap/.git" ]; then
   git -C "$HOME/.local/share/zsh/zsh/zsh-snap" pull -q &>/dev/null
else
   git clone "https://github.com/zsh-users/marlonrichert/zsh-snap" "$HOME/.local/share/zsh/zsh-snap" &>/dev/null
fi
